...
module.exports = "<h1 translate>Title</h1>\n\n<button (click)=\"switchLanguage('es')\">Español</button>\n<button (click)=\"switchLanguage('en')\">Ingles</button>"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.switchLanguage = function (len) {
...
function HttpLoaderFactory(http) {
    return new __WEBPACK_IMPORTED_MODULE_5__ngx_translate_http_loader__["a" /* TranslateHttpLoader */](http, 'https://github.com/AlejandroApestegui/Translate/tree/master/src/assets/i18n/', '.json');
}
